...
return [
    ...
    'reports-index-start'    => 'Firefly III ondersteunt een aantal soorten rapporten. Je kan meer over ze lezen door op het <i class="fa fa-question-circle"></i>-icoontje te klikken (rechtsboven).',
