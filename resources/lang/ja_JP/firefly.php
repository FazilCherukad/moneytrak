...
return [
    ...
    'rule_help_strict'                                    => '厳密モードのルールでアクションが実行されるには、すべてのトリガーが適合しなければいけません。非厳密モードでは、いずれかのトリガーだけで十分です。',
    ...
    'rule_trigger_destination_account_id'                 => '送金先口座IDが「:trigger_value」',
    ...
    'rule_trigger_destination_account_is'                 => '送金先口座名が「:trigger_value」',
    ...
    'rule_trigger_destination_account_nr_is'              => '出金元口座番号/IBANが「:trigger_value」',
    ...
    'rule_trigger_recurrence_id'                          => '定期的な取引 ID が「:trigger_value」',
    ...
    'create_rule_from_transaction'              => '取引をもとにルールを作成',
    ...
    'expense_per_source_account'                => '源泉口座ごとの支出',
    ...
    'to_get_started'                            => 'Firefly III が正常にインストールされました。 始めるに、銀行名とメイン口座の残高を入力してください。 複数の口座を持っている場合も心配いりません。後で追加することができます。Firefly III は始めるため、ひとつ必要としているだけです。',
