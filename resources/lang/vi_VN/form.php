...
return [
    ...
    'account_areYouSure_js'       => 'Bạn có chắc chắn muốn xóa tài khoản có tên "{name}"?',
    ...
    'also_delete_transactions_js' => 'Không có giao dịch nào | Giao dịch duy nhất được kết nối với tài khoản này cũng sẽ bị xóa.|Tất cả {count} giao dịch được kết nối với tài khoản này cũng sẽ bị xóa.',
    ...
    'also_delete_piggyBanks_js'   => 'Không có heo đất | Con heo đất duy nhất được kết nối với tài khoản này cũng sẽ bị xóa. | Tất cả {count} heo đất được kết nối với tài khoản này cũng sẽ bị xóa.',
